About keras-applications-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/keras-applications-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/keras-team/keras-applications
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3068&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/keras-applications-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `keras-applications` can be installed with `conda`:
...
```
mamba install keras-applications
```

It is possible to list all of the versions of `keras-applications` available on your platform with `conda`:
...
```
mamba search keras-applications --channel conda-forge
```
...
mamba repoquery search keras-applications --channel conda-forge

# List packages depending on `keras-applications`:
mamba repoquery whoneeds keras-applications --channel conda-forge

# List dependencies of `keras-applications`:
mamba repoquery depends keras-applications --channel conda-forge
```
